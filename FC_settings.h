...
#include "led_driver.h"
    ...
    #define _FC0_1 ((FREQ_MUL__12 | FREQ_MOD__LF | SUBP_NUM__96 | SCAN_NUM__32) >> 16) & 0xFFFF
    #define _FC0_0 ((LODRM_EN_0 | PSP_MOD_0 | PS_EN_0 | PDC_EN_1 | CHIP_NUM__2)) & 0xFFFF
    
    #define _FC1_2 ((BLK_ADJ_0 | LINE_SWT__90 | LG_ENH_B_2 | LG_ENH_G_15) >> 32) & 0xFFFF
    #define _FC1_1 ((LG_ENH_G_15 | LG_ENH_R_1 | LG_STEP_B__6 | LG_STEP_G__6) >> 16) & 0xFFFF
    #define _FC1_0 ((LG_STEP_G__6 | LG_STEP_R__6 | SEG_LENGTH__682)) & 0xFFFF
...
#elif TLC6984
    #define _FC0_2 ((LSD_RM_EN_0 | GRP_DLY_B_0 | GRP_DLY_G_0 | GRP_DLY_R_0 | FREQ_MUL__12) >> 32) & 0xFFFF
    #define _FC0_1 ((FREQ_MUL__12 | FREQ_MOD__LF | SUBP_NUM__96 | SCAN_NUM__32) >> 16) & 0xFFFF
    #define _FC0_0 ((LODRM_EN_0 | PSP_MOD_0 | PS_EN_0 | PDC_EN_1 | CHIP_NUM__2)) & 0xFFFF
    ...
    #define _FC2_2 ((MPSM_EN_0 | MOD_SIZE_1 | SUBP_MAX_256_0 | CH_B_IMMUNITY_0 | CH_G_IMMUNITY_0 | CH_R_IMMUNITY_0 | LG_COLOR_B__14) >> 32) & 0xFFFF
    #define _FC2_1 ((LG_COLOR_G__14 | LG_COLOR_R__1 | DE_COUPLE1_B__4 | DE_COUPLE1_G__4) >> 16) & 0xFFFF
    #define _FC2_0 ((DE_COUPLE1_R__1 | V_PDC_B__0V1 | V_PDC_G__0V1 | V_PDC_R__0V1)) & 0xFFFF
    ...
    #define _FC0_1 ((FREQ_MUL__10 | FREQ_MOD__LF | SUBP_NUM__128 | SCAN_NUM__16) >> 16) & 0xFFFF
...
#elif LP5891
    #define _FC0_2 ((LSD_RM_EN_0 | GRP_DLY_B_0 | GRP_DLY_G_0 | GRP_DLY_R_0 | FREQ_MUL__10) >> 32) & 0xFFFF
    #define _FC0_1 ((FREQ_MUL__10 | FREQ_MOD__LF | SUBP_NUM__128 | SCAN_NUM__16) >> 16) & 0xFFFF
    #define _FC0_0 ((LODRM_EN_0 | PSP_MOD_0 | PS_EN_0 | PDC_EN_1 | CHIP_NUM__1)) & 0xFFFF
