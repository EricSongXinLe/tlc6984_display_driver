...
#define MOD_SIZE__3                        (0xC00000000000)        /* 3 devices stackable operation */
#define MOD_SIZE__1                        (0x400000000000)        /* 1 device non-stackable operation, SCAN_NUM must <=16 */
#define MOD_SIZE__2                        (0x000000000000)        /* 2 devices stackable operation */
#define BACK_TH__1                         (0x100000000000)        /*  */
...
#define GRP_DLY_B__7                       (0x0E0000000000)        /* 7 GCLK */
#define GRP_DLY_B__6                       (0x0C0000000000)        /* 6 GCLK */
#define GRP_DLY_B__5                       (0x0A0000000000)        /* 5 GCLK */
#define GRP_DLY_B__4                       (0x080000000000)        /* 4 GCLK */
#define GRP_DLY_B__3                       (0x060000000000)        /* 3 GCLK */
#define GRP_DLY_B__2                       (0x040000000000)        /* 2 GCLK */
#define GRP_DLY_B__1                       (0x020000000000)        /* 1 GCLK */
...
#define GRP_DLY_G__7                       (0x01C000000000)        /* 7 GCLK */
#define GRP_DLY_G__6                       (0x018000000000)        /* 6 GCLK */
#define GRP_DLY_G__5                       (0x014000000000)        /* 5 GCLK */
#define GRP_DLY_G__4                       (0x010000000000)        /* 4 GCLK */
#define GRP_DLY_G__3                       (0x00C000000000)        /* 3 GCLK */
#define GRP_DLY_G__2                       (0x008000000000)        /* 2 GCLK */
#define GRP_DLY_G__1                       (0x004000000000)        /* 1 GCLK */
...
#define GRP_DLY_R__7                       (0x003800000000)        /* 7 GCLK */
#define GRP_DLY_R__6                       (0x003000000000)        /* 6 GCLK */
#define GRP_DLY_R__5                       (0x002800000000)        /* 5 GCLK */
#define GRP_DLY_R__4                       (0x002000000000)        /* 4 GCLK */
#define GRP_DLY_R__3                       (0x001800000000)        /* 3 GCLK */
#define GRP_DLY_R__2                       (0x001000000000)        /* 2 GCLK */
#define GRP_DLY_R__1                       (0x000800000000)        /* 1 GCLK */
#define GRP_DLY_R__0                       (0x000000000000)        /* no delay */
#define LINE_CHRG__1                       (0x000100000000)        /*  */
...
#define FREQ_MOD__1                        (0x000008000000)        /* high frequency mode, 80MHz to 160MHz */
#define FREQ_MOD__0                        (0x000000000000)        /* low frequency mode, 40MHz to 80MHz */
#define FREQ_MOD__HF                       (0x000008000000)        /* high frequency mode, 80MHz to 160MHz */
#define FREQ_MOD__LF                       (0x000000000000)        /* low frequency mode, 40MHz to 80MHz */
...
#define SCAN_NUM__MAX                      (0x0000001F0000)        /* 32 lines */
...
#define FLEX_SCAN_1                        (0x000000000040)        /* enable */
#define FLEX_SCAN_0                        (0x000000000000)        /* disable */
#define FLEX_SCAN__1                       (0x000000000040)        /* enable */
#define FLEX_SCAN__0                       (0x000000000000)        /* disable */
...
#define IMAX_1                             (0x000000000008)        /* 20 mA maximum */
#define IMAX_0                             (0x000000000000)        /* 10 mA maximum */
#define IMAX__20                           (0x000000000008)        /* 20 mA maximum */
#define IMAX__10                           (0x000000000000)        /* 10 mA maximum */
#define LAST_SOUT_1                        (0x000000000001)        /* enabled */
#define LAST_SOUT_0                        (0x000000000000)        /* disable */
#define LAST_SOUT__1                       (0x000000000001)        /* enabled */
#define LAST_SOUT__0                       (0x000000000000)        /* disable */
