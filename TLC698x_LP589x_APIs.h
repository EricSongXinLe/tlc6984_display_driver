...
#if MONOCHROMATIC
    extern uint16_t img_mono[SCREEN_SIZE_Y][SCREEN_SIZE_X][CCSI_BUS_NUM];
#else
    extern uint16_t img_R_RGB[SCREEN_SIZE_Y][SCREEN_SIZE_X][CCSI_BUS_NUM];
    extern uint16_t img_G_RGB[SCREEN_SIZE_Y][SCREEN_SIZE_X][CCSI_BUS_NUM];
    extern uint16_t img_B_RGB[SCREEN_SIZE_Y][SCREEN_SIZE_X][CCSI_BUS_NUM];
#endif
